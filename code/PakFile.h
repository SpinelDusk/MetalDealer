...
/// \brief The class contains data and functions necessary for packing PAK files
class PakPack
{
	private:
	/// \brief File signature (0xFEEDFACE)
	cnv::dword FileSignature;
	...
	/// \brief Get archive signature
	cnv::dword GetFileSignature(){return FileSignature;}
...
/// \brief The class contains data and functions necessary for unpacking PAK files
class PakUnpack
{
	private:
	/// \brief File signature (0xFEEDFACE)
